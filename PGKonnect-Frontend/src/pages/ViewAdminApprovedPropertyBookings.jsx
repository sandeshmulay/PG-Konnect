...
const ViewAdminApprovedPropertyBookings = () => {
  ...
  const retrieveBookings = async () => {
    const response = await axios.get(
      "http://localhost:8080/api/property/booking/fetch/status-wise?status=APPROVED",
      {
        headers: {
...
export default ViewAdminApprovedPropertyBookings;
