...
const ViewGuestRejectedPropertyBookings = () => {
  ...
  const retrieveBookings = async () => {
    const response = await axios.get(
      "http://localhost:8080/api/property/booking/fetch/guest-wise?status=REJECTED&guestId=" +
        guest.id,
      {
        headers: {
...
export default ViewGuestRejectedPropertyBookings;
