...
const ViewOwnerPendingPropertyBookings = () => {
  ...
  const retrieveBookings = async () => {
    const response = await axios.get(
      "http://localhost:8080/api/property/booking/fetch/owner-wise?status=PENDING&ownerId=" +
        owner.id,
      {
        headers: {
...
export default ViewOwnerPendingPropertyBookings;
