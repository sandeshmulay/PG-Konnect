...
const ViewOwnerRejectedPropertyBookings = () => {
  ...
  const retrieveBookings = async () => {
    const response = await axios.get(
      "http://localhost:8080/api/property/booking/fetch/owner-wise?status=REJECTED&ownerId=" +
        owner.id,
      {
        headers: {
...
export default ViewOwnerRejectedPropertyBookings;
